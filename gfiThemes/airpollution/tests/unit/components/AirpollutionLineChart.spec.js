...
import AirpollutionLineChart from "../../../components/AirpollutionLineChart.vue";
...
localVue.use(Vuex);
describe("src/modules/tools/gfi/components/themes/verkehrsstaerken/components/AirpollutionLineChart.vue", () => {
    ...
    beforeEach(() => {
        wrapper = shallowMount(AirpollutionLineChart, {
            propsData: {
                dataset: dataset
            },
            data () {
